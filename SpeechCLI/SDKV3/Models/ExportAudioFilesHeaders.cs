...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for ExportAudioFiles operation.
    /// </summary>
    public partial class ExportAudioFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ExportAudioFilesHeaders class.
        /// </summary>
        public ExportAudioFilesHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public ExportAudioFilesHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
