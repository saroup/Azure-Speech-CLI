...
namespace Speech.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PaginatedEndpoints class.
        /// </summary>
        ...
        public PaginatedEndpoints(IList<Endpoint> values = default(IList<Endpoint>), string nextLink = default(string))
        {
            Values = values;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<Endpoint> Values { get; private set; }
