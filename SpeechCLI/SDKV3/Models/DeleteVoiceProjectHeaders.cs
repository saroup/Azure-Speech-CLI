...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteVoiceProject operation.
    /// </summary>
    public partial class DeleteVoiceProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteVoiceProjectHeaders class.
        /// </summary>
        public DeleteVoiceProjectHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteVoiceProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
