...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceTestFiles operation.
    /// </summary>
    public partial class GetVoiceTestFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceTestFilesHeaders class.
        /// </summary>
        public GetVoiceTestFilesHeaders()
        {
            CustomInit();
        }
        ...
        public GetVoiceTestFilesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
