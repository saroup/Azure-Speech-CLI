...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class UpdateVoiceModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateVoiceModelHeaders class.
        /// </summary>
        public UpdateVoiceModelHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateVoiceModelHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
