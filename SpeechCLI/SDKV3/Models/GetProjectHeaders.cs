...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetProject operation.
    /// </summary>
    public partial class GetProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetProjectHeaders class.
        /// </summary>
        ...
        /// UTC.</param>
        public GetProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
