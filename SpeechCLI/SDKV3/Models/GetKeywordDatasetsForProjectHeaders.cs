...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordDatasetsForProject operation.
    /// </summary>
    public partial class GetKeywordDatasetsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetKeywordDatasetsForProjectHeaders class.
        /// </summary>
        public GetKeywordDatasetsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetKeywordDatasetsForProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
