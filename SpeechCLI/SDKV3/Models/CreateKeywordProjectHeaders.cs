...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateKeywordProject operation.
    /// </summary>
    public partial class CreateKeywordProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateKeywordProjectHeaders
        /// class.
        /// </summary>
        public CreateKeywordProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateKeywordProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
