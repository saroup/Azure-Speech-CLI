...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetEndpointDataExportHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetEndpointDataExportHeaders
        /// class.
        /// </summary>
        public GetEndpointDataExportHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetEndpointDataExportHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
