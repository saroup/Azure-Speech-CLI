...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceProjects operation.
    /// </summary>
    public partial class GetVoiceProjectsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceProjectsHeaders class.
        /// </summary>
        public GetVoiceProjectsHeaders()
        {
            CustomInit();
        }
        ...
        public GetVoiceProjectsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
