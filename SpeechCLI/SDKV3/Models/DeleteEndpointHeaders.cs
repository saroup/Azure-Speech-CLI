...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class DeleteEndpointHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteEndpointHeaders class.
        /// </summary>
        public DeleteEndpointHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteEndpointHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
