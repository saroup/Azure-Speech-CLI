...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetEndpointLog operation.
    /// </summary>
    public partial class GetEndpointLogHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetEndpointLogHeaders class.
        /// </summary>
        public GetEndpointLogHeaders()
        {
            CustomInit();
        }
        ...
        public GetEndpointLogHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
