...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordDataset operation.
    /// </summary>
    public partial class GetKeywordDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeywordDatasetHeaders class.
        /// </summary>
        public GetKeywordDatasetHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetKeywordDatasetHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
