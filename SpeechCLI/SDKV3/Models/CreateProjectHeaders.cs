...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateProject operation.
    /// </summary>
    public partial class CreateProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateProjectHeaders class.
        /// </summary>
        public CreateProjectHeaders()
        {
            CustomInit();
        }
        ...
        public CreateProjectHeaders(string location = default(string), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
            Location = location;
