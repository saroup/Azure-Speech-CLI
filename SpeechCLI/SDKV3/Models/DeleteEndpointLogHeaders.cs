...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteEndpointLog operation.
    /// </summary>
    public partial class DeleteEndpointLogHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteEndpointLogHeaders class.
        /// </summary>
        public DeleteEndpointLogHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteEndpointLogHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
