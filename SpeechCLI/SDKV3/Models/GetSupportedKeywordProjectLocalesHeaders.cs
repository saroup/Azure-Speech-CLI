...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetSupportedKeywordProjectLocales operation.
    /// </summary>
    public partial class GetSupportedKeywordProjectLocalesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedKeywordProjectLocalesHeaders class.
        /// </summary>
        public GetSupportedKeywordProjectLocalesHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedKeywordProjectLocalesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
