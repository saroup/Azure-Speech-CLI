...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetTranscriptionFiles operation.
    /// </summary>
    public partial class GetTranscriptionFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTranscriptionFilesHeaders
        /// class.
        /// </summary>
        public GetTranscriptionFilesHeaders()
        {
            CustomInit();
        }
        ...
        public GetTranscriptionFilesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
