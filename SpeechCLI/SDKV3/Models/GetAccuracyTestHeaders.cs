...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetAccuracyTestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetAccuracyTestHeaders class.
        /// </summary>
        public GetAccuracyTestHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetAccuracyTestHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
