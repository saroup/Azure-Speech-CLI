...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteDataCollectionDonation operation.
    /// </summary>
    public partial class DeleteDataCollectionDonationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DeleteDataCollectionDonationHeaders class.
        /// </summary>
        public DeleteDataCollectionDonationHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteDataCollectionDonationHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
