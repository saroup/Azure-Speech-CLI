...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteEndpointLogs operation.
    /// </summary>
    public partial class DeleteEndpointLogsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteEndpointLogsHeaders class.
        /// </summary>
        public DeleteEndpointLogsHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteEndpointLogsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
