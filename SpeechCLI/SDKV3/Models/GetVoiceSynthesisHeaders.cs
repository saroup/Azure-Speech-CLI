...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceSynthesis operation.
    /// </summary>
    public partial class GetVoiceSynthesisHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceSynthesisHeaders class.
        /// </summary>
        public GetVoiceSynthesisHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceSynthesisHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
