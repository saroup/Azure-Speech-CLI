...
namespace Speech.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PaginatedWebHooks class.
        /// </summary>
        public PaginatedWebHooks()
        {
            CustomInit();
        }
        ...
        public PaginatedWebHooks(IList<WebHook> values = default(IList<WebHook>), string nextLink = default(string))
        {
            Values = values;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<WebHook> Values { get; private set; }
