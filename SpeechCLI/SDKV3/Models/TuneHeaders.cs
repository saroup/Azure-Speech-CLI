...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for Tune operation.
    /// </summary>
    public partial class TuneHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TuneHeaders class.
        /// </summary>
        public TuneHeaders()
        {
            CustomInit();
        ...
        /// UTC.</param>
        public TuneHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
