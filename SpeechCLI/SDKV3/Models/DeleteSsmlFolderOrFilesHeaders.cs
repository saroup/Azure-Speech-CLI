...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteSsmlFolderOrFiles operation.
    /// </summary>
    public partial class DeleteSsmlFolderOrFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteSsmlFolderOrFilesHeaders
        /// class.
        /// </summary>
        public DeleteSsmlFolderOrFilesHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public DeleteSsmlFolderOrFilesHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
