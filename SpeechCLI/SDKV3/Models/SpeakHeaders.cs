...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for Speak operation.
    /// </summary>
    public partial class SpeakHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SpeakHeaders class.
        /// </summary>
        public SpeakHeaders()
        {
            CustomInit();
        ...
        /// UTC.</param>
        public SpeakHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
