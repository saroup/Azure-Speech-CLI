...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateEndpointManifest operation.
    /// </summary>
    public partial class CreateEndpointManifestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateEndpointManifestHeaders
        /// class.
        /// </summary>
        public CreateEndpointManifestHeaders()
        {
            CustomInit();
        }
        ...
        public CreateEndpointManifestHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
