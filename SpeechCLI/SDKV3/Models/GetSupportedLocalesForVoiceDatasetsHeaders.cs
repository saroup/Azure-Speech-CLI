...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetSupportedLocalesForVoiceDatasetsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedLocalesForVoiceDatasetsHeaders class.
        /// </summary>
        public GetSupportedLocalesForVoiceDatasetsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedLocalesForVoiceDatasetsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
