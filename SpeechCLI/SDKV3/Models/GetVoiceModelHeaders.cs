...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetVoiceModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceModelHeaders class.
        /// </summary>
        public GetVoiceModelHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceModelHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
