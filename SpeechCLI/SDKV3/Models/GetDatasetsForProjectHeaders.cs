...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDatasetsForProject operation.
    /// </summary>
    public partial class GetDatasetsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDatasetsForProjectHeaders
        /// class.
        /// </summary>
        public GetDatasetsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        public GetDatasetsForProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
