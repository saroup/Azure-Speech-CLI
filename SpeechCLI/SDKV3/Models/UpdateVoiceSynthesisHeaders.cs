...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateVoiceSynthesis operation.
    /// </summary>
    public partial class UpdateVoiceSynthesisHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateVoiceSynthesisHeaders
        /// class.
        /// </summary>
        public UpdateVoiceSynthesisHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateVoiceSynthesisHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
