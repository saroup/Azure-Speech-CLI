...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetTranscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTranscriptionHeaders class.
        /// </summary>
        public GetTranscriptionHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetTranscriptionHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
