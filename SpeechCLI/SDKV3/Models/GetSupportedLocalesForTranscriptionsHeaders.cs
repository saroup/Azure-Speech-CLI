...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetSupportedLocalesForTranscriptionsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedLocalesForTranscriptionsHeaders class.
        /// </summary>
        public GetSupportedLocalesForTranscriptionsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedLocalesForTranscriptionsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
