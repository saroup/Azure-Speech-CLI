...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateKeywordProject operation.
    /// </summary>
    public partial class UpdateKeywordProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateKeywordProjectHeaders
        /// class.
        /// </summary>
        public UpdateKeywordProjectHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateKeywordProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
