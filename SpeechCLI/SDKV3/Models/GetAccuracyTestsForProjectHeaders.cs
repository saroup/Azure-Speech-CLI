...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetAccuracyTestsForProject operation.
    /// </summary>
    public partial class GetAccuracyTestsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetAccuracyTestsForProjectHeaders
        /// class.
        /// </summary>
        public GetAccuracyTestsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        public GetAccuracyTestsForProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
