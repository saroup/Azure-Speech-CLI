...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteVoiceGeneralTasks operation.
    /// </summary>
    public partial class DeleteVoiceGeneralTasksHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteVoiceGeneralTasksHeaders
        /// class.
        /// </summary>
        public DeleteVoiceGeneralTasksHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteVoiceGeneralTasksHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
