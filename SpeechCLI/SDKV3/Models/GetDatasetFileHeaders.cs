...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDatasetFile operation.
    /// </summary>
    public partial class GetDatasetFileHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDatasetFileHeaders class.
        /// </summary>
        public GetDatasetFileHeaders()
        {
            CustomInit();
        }
        ...
        public GetDatasetFileHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
