...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordDatasets operation.
    /// </summary>
    public partial class GetKeywordDatasetsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeywordDatasetsHeaders class.
        /// </summary>
        public GetKeywordDatasetsHeaders()
        {
            CustomInit();
        }
        ...
        public GetKeywordDatasetsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
