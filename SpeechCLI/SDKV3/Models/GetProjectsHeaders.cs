...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetProjects operation.
    /// </summary>
    public partial class GetProjectsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetProjectsHeaders class.
        /// </summary>
        ...
        public GetProjectsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
