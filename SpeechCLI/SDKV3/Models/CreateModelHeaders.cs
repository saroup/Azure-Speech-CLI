...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class CreateModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateModelHeaders class.
        /// </summary>
        public CreateModelHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateModelHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
