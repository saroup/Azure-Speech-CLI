...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceProject operation.
    /// </summary>
    public partial class GetVoiceProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceProjectHeaders class.
        /// </summary>
        public GetVoiceProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
