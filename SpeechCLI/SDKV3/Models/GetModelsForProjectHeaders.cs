...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetModelsForProject operation.
    /// </summary>
    public partial class GetModelsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetModelsForProjectHeaders class.
        /// </summary>
        public GetModelsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        public GetModelsForProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
