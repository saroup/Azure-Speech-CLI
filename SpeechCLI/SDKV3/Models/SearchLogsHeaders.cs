...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for SearchLogs operation.
    /// </summary>
    public partial class SearchLogsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SearchLogsHeaders class.
        /// </summary>
        public SearchLogsHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public SearchLogsHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
