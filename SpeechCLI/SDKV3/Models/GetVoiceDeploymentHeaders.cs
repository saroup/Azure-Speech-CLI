...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetVoiceDeploymentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceDeploymentHeaders class.
        /// </summary>
        public GetVoiceDeploymentHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceDeploymentHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
