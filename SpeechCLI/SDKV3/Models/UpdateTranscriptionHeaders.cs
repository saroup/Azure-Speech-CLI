...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class UpdateTranscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateTranscriptionHeaders class.
        /// </summary>
        public UpdateTranscriptionHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateTranscriptionHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
