...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetSupportedVoicesForVoiceSynthesis operation.
    /// </summary>
    public partial class GetSupportedVoicesForVoiceSynthesisHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedVoicesForVoiceSynthesisHeaders class.
        /// </summary>
        public GetSupportedVoicesForVoiceSynthesisHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedVoicesForVoiceSynthesisHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
