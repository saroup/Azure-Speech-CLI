...
namespace Speech.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PaginatedTranscriptions class.
        /// </summary>
        public PaginatedTranscriptions()
        {
            CustomInit();
        }
        ...
        public PaginatedTranscriptions(IList<Transcription> values = default(IList<Transcription>), string nextLink = default(string))
        {
            Values = values;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<Transcription> Values { get; private set; }
