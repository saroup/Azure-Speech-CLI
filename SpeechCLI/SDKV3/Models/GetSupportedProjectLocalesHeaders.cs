...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetSupportedProjectLocales operation.
    /// </summary>
    public partial class GetSupportedProjectLocalesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetSupportedProjectLocalesHeaders
        /// class.
        /// </summary>
        public GetSupportedProjectLocalesHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedProjectLocalesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
