...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordProjects operation.
    /// </summary>
    public partial class GetKeywordProjectsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeywordProjectsHeaders class.
        /// </summary>
        public GetKeywordProjectsHeaders()
        {
            CustomInit();
        }
        ...
        public GetKeywordProjectsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
