...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for QueryTuneMetadata operation.
    /// </summary>
    public partial class QueryTuneMetadataHeaders
    {
        /// <summary>
        /// Initializes a new instance of the QueryTuneMetadataHeaders class.
        /// </summary>
        public QueryTuneMetadataHeaders()
        {
            CustomInit();
        }
        ...
        /// resource.</param>
        /// <param name="operationLocation">The location of the created
        /// resource.</param>
        /// <param name="retryAfter">The minimum number of seconds to wait
        /// before not getting this response anymore.</param>
        public QueryTuneMetadataHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), string location = default(string), string operationLocation = default(string), int? retryAfter = default(int?))
        {
