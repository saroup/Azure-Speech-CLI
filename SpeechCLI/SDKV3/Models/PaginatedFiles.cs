...
namespace Speech.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PaginatedFiles class.
        /// </summary>
        ...
        public PaginatedFiles(IList<File> values = default(IList<File>), string nextLink = default(string))
        {
            Values = values;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<File> Values { get; private set; }
