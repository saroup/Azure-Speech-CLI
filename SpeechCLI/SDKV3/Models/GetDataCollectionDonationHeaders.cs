...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDataCollectionDonation operation.
    /// </summary>
    public partial class GetDataCollectionDonationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDataCollectionDonationHeaders
        /// class.
        /// </summary>
        public GetDataCollectionDonationHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetDataCollectionDonationHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
