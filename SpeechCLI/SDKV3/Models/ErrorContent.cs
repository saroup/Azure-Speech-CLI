...
namespace Speech.Models
{
    ...
    public partial class ErrorContent
    {
        ...
        public ErrorContent(string code, string message, IList<ErrorDetail> details = default(IList<ErrorDetail>), InnerErrorV2 innererror = default(InnerErrorV2), string target = default(string))
        {
            Details = details;
