...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CopyVoiceModel operation.
    /// </summary>
    public partial class CopyVoiceModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CopyVoiceModelHeaders class.
        /// </summary>
        public CopyVoiceModelHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CopyVoiceModelHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
