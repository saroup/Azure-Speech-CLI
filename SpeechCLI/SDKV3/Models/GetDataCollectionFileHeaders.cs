...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDataCollectionFile operation.
    /// </summary>
    public partial class GetDataCollectionFileHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDataCollectionFileHeaders
        /// class.
        /// </summary>
        public GetDataCollectionFileHeaders()
        {
            CustomInit();
        }
        ...
        public GetDataCollectionFileHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
