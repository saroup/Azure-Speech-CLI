...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetBaseModels operation.
    /// </summary>
    public partial class GetBaseModelsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetBaseModelsHeaders class.
        /// </summary>
        public GetBaseModelsHeaders()
        {
            CustomInit();
        }
        ...
        public GetBaseModelsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
