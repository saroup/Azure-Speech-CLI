...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteVoiceSynthesis operation.
    /// </summary>
    public partial class DeleteVoiceSynthesisHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteVoiceSynthesisHeaders
        /// class.
        /// </summary>
        public DeleteVoiceSynthesisHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteVoiceSynthesisHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
