...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetSupportedLocalesForVoiceEndpointsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedLocalesForVoiceEndpointsHeaders class.
        /// </summary>
        public GetSupportedLocalesForVoiceEndpointsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedLocalesForVoiceEndpointsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
