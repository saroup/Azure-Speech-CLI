...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetHooks operation.
    /// </summary>
    public partial class GetHooksHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetHooksHeaders class.
        /// </summary>
        public GetHooksHeaders()
        {
            CustomInit();
        }
        ...
        public GetHooksHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
