...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetSupportedVoiceProjectLocales operation.
    /// </summary>
    public partial class GetSupportedVoiceProjectLocalesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedVoiceProjectLocalesHeaders class.
        /// </summary>
        public GetSupportedVoiceProjectLocalesHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedVoiceProjectLocalesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
