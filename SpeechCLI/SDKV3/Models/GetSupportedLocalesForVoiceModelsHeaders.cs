...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetSupportedLocalesForVoiceModelsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedLocalesForVoiceModelsHeaders class.
        /// </summary>
        public GetSupportedLocalesForVoiceModelsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedLocalesForVoiceModelsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
