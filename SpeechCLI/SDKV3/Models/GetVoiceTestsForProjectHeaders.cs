...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceTestsForProject operation.
    /// </summary>
    public partial class GetVoiceTestsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceTestsForProjectHeaders
        /// class.
        /// </summary>
        public GetVoiceTestsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceTestsForProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
