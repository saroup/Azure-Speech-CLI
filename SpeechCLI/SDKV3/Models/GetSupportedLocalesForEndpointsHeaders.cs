...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetSupportedLocalesForEndpointsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedLocalesForEndpointsHeaders class.
        /// </summary>
        public GetSupportedLocalesForEndpointsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedLocalesForEndpointsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
