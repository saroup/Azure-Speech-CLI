...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateVoiceProject operation.
    /// </summary>
    public partial class CreateVoiceProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateVoiceProjectHeaders class.
        /// </summary>
        public CreateVoiceProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateVoiceProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
