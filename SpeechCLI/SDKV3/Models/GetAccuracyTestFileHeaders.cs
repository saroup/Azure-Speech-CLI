...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetAccuracyTestFile operation.
    /// </summary>
    public partial class GetAccuracyTestFileHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetAccuracyTestFileHeaders class.
        /// </summary>
        public GetAccuracyTestFileHeaders()
        {
            CustomInit();
        }
        ...
        public GetAccuracyTestFileHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
