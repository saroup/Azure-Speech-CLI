...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceDatasetFiles operation.
    /// </summary>
    public partial class GetVoiceDatasetFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceDatasetFilesHeaders
        /// class.
        /// </summary>
        public GetVoiceDatasetFilesHeaders()
        {
            CustomInit();
        }
        ...
        public GetVoiceDatasetFilesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
