...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteKeywordProject operation.
    /// </summary>
    public partial class DeleteKeywordProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteKeywordProjectHeaders
        /// class.
        /// </summary>
        public DeleteKeywordProjectHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteKeywordProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
