...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordProject operation.
    /// </summary>
    public partial class GetKeywordProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeywordProjectHeaders class.
        /// </summary>
        public GetKeywordProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetKeywordProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
