...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UploadVoiceLongAudioDataset operation.
    /// </summary>
    public partial class UploadVoiceLongAudioDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// UploadVoiceLongAudioDatasetHeaders class.
        /// </summary>
        public UploadVoiceLongAudioDatasetHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public UploadVoiceLongAudioDatasetHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
