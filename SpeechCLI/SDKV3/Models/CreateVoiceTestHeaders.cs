...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class CreateVoiceTestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateVoiceTestHeaders class.
        /// </summary>
        public CreateVoiceTestHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateVoiceTestHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
