...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceDatasetsForProject operation.
    /// </summary>
    public partial class GetVoiceDatasetsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceDatasetsForProjectHeaders
        /// class.
        /// </summary>
        public GetVoiceDatasetsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceDatasetsForProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
