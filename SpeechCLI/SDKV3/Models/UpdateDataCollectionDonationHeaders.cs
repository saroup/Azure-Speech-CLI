...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateDataCollectionDonation operation.
    /// </summary>
    public partial class UpdateDataCollectionDonationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// UpdateDataCollectionDonationHeaders class.
        /// </summary>
        public UpdateDataCollectionDonationHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateDataCollectionDonationHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
