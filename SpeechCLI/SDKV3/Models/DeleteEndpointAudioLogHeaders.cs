...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteEndpointAudioLog operation.
    /// </summary>
    public partial class DeleteEndpointAudioLogHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteEndpointAudioLogHeaders
        /// class.
        /// </summary>
        public DeleteEndpointAudioLogHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteEndpointAudioLogHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
