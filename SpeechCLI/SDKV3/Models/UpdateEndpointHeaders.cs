...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class UpdateEndpointHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateEndpointHeaders class.
        /// </summary>
        public UpdateEndpointHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateEndpointHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), string location = default(string), string operationLocation = default(string), int? retryAfter = default(int?))
        {
