...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateVoiceDataset operation.
    /// </summary>
    public partial class CreateVoiceDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateVoiceDatasetHeaders class.
        /// </summary>
        public CreateVoiceDatasetHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateVoiceDatasetHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
