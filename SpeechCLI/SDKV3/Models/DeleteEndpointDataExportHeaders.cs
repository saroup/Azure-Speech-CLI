...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class DeleteEndpointDataExportHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteEndpointDataExportHeaders
        /// class.
        /// </summary>
        public DeleteEndpointDataExportHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteEndpointDataExportHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
