...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateProject operation.
    /// </summary>
    public partial class UpdateProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateProjectHeaders class.
        /// </summary>
        public UpdateProjectHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
