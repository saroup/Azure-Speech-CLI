...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteProject operation.
    /// </summary>
    public partial class DeleteProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteProjectHeaders class.
        /// </summary>
        public DeleteProjectHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
