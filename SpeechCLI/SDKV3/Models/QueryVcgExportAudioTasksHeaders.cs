...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for QueryVcgExportAudioTasks operation.
    /// </summary>
    public partial class QueryVcgExportAudioTasksHeaders
    {
        /// <summary>
        /// Initializes a new instance of the QueryVcgExportAudioTasksHeaders
        /// class.
        /// </summary>
        public QueryVcgExportAudioTasksHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public QueryVcgExportAudioTasksHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
