...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for IsCurrentSubscriptionInGroup operation.
    /// </summary>
    public partial class IsCurrentSubscriptionInGroupHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// IsCurrentSubscriptionInGroupHeaders class.
        /// </summary>
        public IsCurrentSubscriptionInGroupHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public IsCurrentSubscriptionInGroupHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
