...
namespace Speech.Models
{
    ...
    public partial class GetModelHeaders
    {
        ...
        /// UTC.</param>
        public GetModelHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
