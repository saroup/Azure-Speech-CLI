...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceDataset operation.
    /// </summary>
    public partial class GetVoiceDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceDatasetHeaders class.
        /// </summary>
        public GetVoiceDatasetHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceDatasetHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
