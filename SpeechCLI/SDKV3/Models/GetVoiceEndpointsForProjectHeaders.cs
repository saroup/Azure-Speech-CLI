...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceEndpointsForProject operation.
    /// </summary>
    public partial class GetVoiceEndpointsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetVoiceEndpointsForProjectHeaders class.
        /// </summary>
        public GetVoiceEndpointsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceEndpointsForProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
