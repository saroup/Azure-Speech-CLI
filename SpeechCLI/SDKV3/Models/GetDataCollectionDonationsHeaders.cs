...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDataCollectionDonations operation.
    /// </summary>
    public partial class GetDataCollectionDonationsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDataCollectionDonationsHeaders
        /// class.
        /// </summary>
        public GetDataCollectionDonationsHeaders()
        {
            CustomInit();
        }
        ...
        public GetDataCollectionDonationsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
