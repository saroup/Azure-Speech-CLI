...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class DeleteVoiceDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteVoiceDatasetHeaders class.
        /// </summary>
        public DeleteVoiceDatasetHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteVoiceDatasetHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
