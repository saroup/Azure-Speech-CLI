...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetEndpointHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetEndpointHeaders class.
        /// </summary>
        public GetEndpointHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetEndpointHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
