...
namespace Speech.Models
{
    ...
    public partial class DeleteModelHeaders
    {
        ...
        public DeleteModelHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
