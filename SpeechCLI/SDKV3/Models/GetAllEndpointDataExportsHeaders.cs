...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetAllEndpointDataExports operation.
    /// </summary>
    public partial class GetAllEndpointDataExportsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetAllEndpointDataExportsHeaders
        /// class.
        /// </summary>
        public GetAllEndpointDataExportsHeaders()
        {
            CustomInit();
        }
        ...
        public GetAllEndpointDataExportsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
