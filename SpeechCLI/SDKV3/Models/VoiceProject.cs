...
namespace Speech.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the VoiceProject class.
        /// </summary>
        public VoiceProject()
        {
            CustomInit();
        ...
        /// entity</param>
        public VoiceProject(string displayName, string locale, string self = default(string), string description = default(string), IDictionary<string, string> properties = default(IDictionary<string, string>))
        {
            Self = self;
