...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class UploadVoiceDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UploadVoiceDatasetHeaders class.
        /// </summary>
        public UploadVoiceDatasetHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public UploadVoiceDatasetHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
