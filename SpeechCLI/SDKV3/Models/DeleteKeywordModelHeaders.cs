...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteKeywordModel operation.
    /// </summary>
    public partial class DeleteKeywordModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteKeywordModelHeaders class.
        /// </summary>
        public DeleteKeywordModelHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteKeywordModelHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
