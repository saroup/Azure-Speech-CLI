...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetSupportedLocalesForVoiceLongAudioDatasets
    /// operation.
    /// </summary>
    public partial class GetSupportedLocalesForVoiceLongAudioDatasetsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedLocalesForVoiceLongAudioDatasetsHeaders class.
        /// </summary>
        public GetSupportedLocalesForVoiceLongAudioDatasetsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedLocalesForVoiceLongAudioDatasetsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
