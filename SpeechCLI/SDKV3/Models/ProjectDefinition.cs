...
namespace Speech.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ProjectDefinition class.
        /// </summary>
        ...
        /// entity</param>
        public ProjectDefinition(string displayName, string locale, string description = default(string), IDictionary<string, string> properties = default(IDictionary<string, string>))
        {
