...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetBaseModelLogs operation.
    /// </summary>
    public partial class GetBaseModelLogsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetBaseModelLogsHeaders class.
        /// </summary>
        public GetBaseModelLogsHeaders()
        {
            CustomInit();
        }
        ...
        public GetBaseModelLogsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
