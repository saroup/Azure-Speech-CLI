...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteBaseModelLog operation.
    /// </summary>
    public partial class DeleteBaseModelLogHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteBaseModelLogHeaders class.
        /// </summary>
        public DeleteBaseModelLogHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteBaseModelLogHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
