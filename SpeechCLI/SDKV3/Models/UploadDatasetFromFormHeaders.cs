...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UploadDatasetFromForm operation.
    /// </summary>
    public partial class UploadDatasetFromFormHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UploadDatasetFromFormHeaders
        /// class.
        /// </summary>
        public UploadDatasetFromFormHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public UploadDatasetFromFormHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
