...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateVoiceProject operation.
    /// </summary>
    public partial class UpdateVoiceProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateVoiceProjectHeaders class.
        /// </summary>
        public UpdateVoiceProjectHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateVoiceProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
