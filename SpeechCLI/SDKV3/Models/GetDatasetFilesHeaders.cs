...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDatasetFiles operation.
    /// </summary>
    public partial class GetDatasetFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDatasetFilesHeaders class.
        /// </summary>
        public GetDatasetFilesHeaders()
        {
            CustomInit();
        }
        ...
        public GetDatasetFilesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
