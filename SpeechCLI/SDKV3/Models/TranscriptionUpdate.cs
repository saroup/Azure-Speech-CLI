...
namespace Speech.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the TranscriptionUpdate class.
        /// </summary>
        ...
        public TranscriptionUpdate(EntityReference project = default(EntityReference), string displayName = default(string), string description = default(string))
        {
            Project = project;
