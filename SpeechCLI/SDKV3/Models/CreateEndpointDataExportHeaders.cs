...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class CreateEndpointDataExportHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateEndpointDataExportHeaders
        /// class.
        /// </summary>
        public CreateEndpointDataExportHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateEndpointDataExportHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
