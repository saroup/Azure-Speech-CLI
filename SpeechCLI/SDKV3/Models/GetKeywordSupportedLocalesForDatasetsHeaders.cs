...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordSupportedLocalesForDatasets operation.
    /// </summary>
    public partial class GetKeywordSupportedLocalesForDatasetsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetKeywordSupportedLocalesForDatasetsHeaders class.
        /// </summary>
        public GetKeywordSupportedLocalesForDatasetsHeaders()
        {
            CustomInit();
        }
        ...
        public GetKeywordSupportedLocalesForDatasetsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
