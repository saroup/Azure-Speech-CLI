...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetBaseModelDataExports operation.
    /// </summary>
    public partial class GetBaseModelDataExportsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetBaseModelDataExportsHeaders
        /// class.
        /// </summary>
        public GetBaseModelDataExportsHeaders()
        {
            CustomInit();
        }
        ...
        public GetBaseModelDataExportsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
