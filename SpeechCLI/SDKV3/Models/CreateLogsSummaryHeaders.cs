...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateLogsSummary operation.
    /// </summary>
    public partial class CreateLogsSummaryHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateLogsSummaryHeaders class.
        /// </summary>
        public CreateLogsSummaryHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateLogsSummaryHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
