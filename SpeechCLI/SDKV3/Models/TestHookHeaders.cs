...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for TestHook operation.
    /// </summary>
    public partial class TestHookHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TestHookHeaders class.
        /// </summary>
        public TestHookHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public TestHookHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
