...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateVoiceEndpointManifest operation.
    /// </summary>
    public partial class CreateVoiceEndpointManifestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateVoiceEndpointManifestHeaders class.
        /// </summary>
        public CreateVoiceEndpointManifestHeaders()
        {
            CustomInit();
        }
        ...
        public CreateVoiceEndpointManifestHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
