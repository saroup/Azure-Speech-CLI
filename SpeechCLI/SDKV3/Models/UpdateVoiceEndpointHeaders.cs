...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class UpdateVoiceEndpointHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateVoiceEndpointHeaders class.
        /// </summary>
        public UpdateVoiceEndpointHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateVoiceEndpointHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
