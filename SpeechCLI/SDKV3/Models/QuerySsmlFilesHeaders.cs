...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for QuerySsmlFiles operation.
    /// </summary>
    public partial class QuerySsmlFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the QuerySsmlFilesHeaders class.
        /// </summary>
        public QuerySsmlFilesHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public QuerySsmlFilesHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
