...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateDatasetFromDonation operation.
    /// </summary>
    public partial class CreateDatasetFromDonationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateDatasetFromDonationHeaders
        /// class.
        /// </summary>
        public CreateDatasetFromDonationHeaders()
        {
            CustomInit();
        }
        ...
        public CreateDatasetFromDonationHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
