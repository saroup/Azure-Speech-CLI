...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetTranscriptionsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTranscriptionsHeaders class.
        /// </summary>
        public GetTranscriptionsHeaders()
        {
            CustomInit();
        }
        ...
        public GetTranscriptionsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
