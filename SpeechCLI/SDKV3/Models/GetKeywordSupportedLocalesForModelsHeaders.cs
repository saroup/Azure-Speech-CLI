...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordSupportedLocalesForModels operation.
    /// </summary>
    public partial class GetKeywordSupportedLocalesForModelsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetKeywordSupportedLocalesForModelsHeaders class.
        /// </summary>
        public GetKeywordSupportedLocalesForModelsHeaders()
        {
            CustomInit();
        }
        ...
        public GetKeywordSupportedLocalesForModelsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
