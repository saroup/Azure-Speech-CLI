...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class DeleteDeploymentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteDeploymentHeaders class.
        /// </summary>
        public DeleteDeploymentHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteDeploymentHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
