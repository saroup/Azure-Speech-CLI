...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceTests operation.
    /// </summary>
    public partial class GetVoiceTestsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceTestsHeaders class.
        /// </summary>
        public GetVoiceTestsHeaders()
        {
            CustomInit();
        }
        ...
        public GetVoiceTestsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
