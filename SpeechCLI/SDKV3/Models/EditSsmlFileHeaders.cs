...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for EditSsmlFile operation.
    /// </summary>
    public partial class EditSsmlFileHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditSsmlFileHeaders class.
        /// </summary>
        public EditSsmlFileHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public EditSsmlFileHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
