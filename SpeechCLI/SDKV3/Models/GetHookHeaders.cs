...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetHook operation.
    /// </summary>
    public partial class GetHookHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetHookHeaders class.
        /// </summary>
        public GetHookHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetHookHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
