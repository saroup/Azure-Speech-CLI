...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordModelFiles operation.
    /// </summary>
    public partial class GetKeywordModelFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeywordModelFilesHeaders
        /// class.
        /// </summary>
        public GetKeywordModelFilesHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetKeywordModelFilesHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
