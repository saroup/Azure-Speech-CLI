...
namespace Speech.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PaginatedDatasets class.
        /// </summary>
        ...
        public PaginatedDatasets(IList<Dataset> values = default(IList<Dataset>), string nextLink = default(string))
        {
            Values = values;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<Dataset> Values { get; private set; }
