...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for SplitSsmls operation.
    /// </summary>
    public partial class SplitSsmlsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SplitSsmlsHeaders class.
        /// </summary>
        public SplitSsmlsHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public SplitSsmlsHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
