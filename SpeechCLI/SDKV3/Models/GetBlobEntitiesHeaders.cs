...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetBlobEntities operation.
    /// </summary>
    public partial class GetBlobEntitiesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetBlobEntitiesHeaders class.
        /// </summary>
        public GetBlobEntitiesHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetBlobEntitiesHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
