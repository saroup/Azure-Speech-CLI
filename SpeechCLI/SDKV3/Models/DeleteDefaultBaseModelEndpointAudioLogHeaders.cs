...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteDefaultBaseModelEndpointAudioLog operation.
    /// </summary>
    public partial class DeleteDefaultBaseModelEndpointAudioLogHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// DeleteDefaultBaseModelEndpointAudioLogHeaders class.
        /// </summary>
        public DeleteDefaultBaseModelEndpointAudioLogHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteDefaultBaseModelEndpointAudioLogHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
