...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class DeleteVoiceModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteVoiceModelHeaders class.
        /// </summary>
        public DeleteVoiceModelHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteVoiceModelHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
