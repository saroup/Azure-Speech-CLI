...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetEndpointLogs operation.
    /// </summary>
    public partial class GetEndpointLogsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetEndpointLogsHeaders class.
        /// </summary>
        public GetEndpointLogsHeaders()
        {
            CustomInit();
        }
        ...
        public GetEndpointLogsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
