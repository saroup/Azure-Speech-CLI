...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetBaseModelLog operation.
    /// </summary>
    public partial class GetBaseModelLogHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetBaseModelLogHeaders class.
        /// </summary>
        public GetBaseModelLogHeaders()
        {
            CustomInit();
        }
        ...
        public GetBaseModelLogHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
