...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateKeywordDataset operation.
    /// </summary>
    public partial class UpdateKeywordDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateKeywordDatasetHeaders
        /// class.
        /// </summary>
        public UpdateKeywordDatasetHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateKeywordDatasetHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
