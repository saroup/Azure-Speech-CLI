...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class UpdateAccuracyTestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateAccuracyTestHeaders class.
        /// </summary>
        public UpdateAccuracyTestHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateAccuracyTestHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
