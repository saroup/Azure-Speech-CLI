...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for SpeakMetadata operation.
    /// </summary>
    public partial class SpeakMetadataHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SpeakMetadataHeaders class.
        /// </summary>
        public SpeakMetadataHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public SpeakMetadataHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
