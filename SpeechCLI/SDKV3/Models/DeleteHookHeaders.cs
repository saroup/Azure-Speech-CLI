...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteHook operation.
    /// </summary>
    public partial class DeleteHookHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteHookHeaders class.
        /// </summary>
        public DeleteHookHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteHookHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
