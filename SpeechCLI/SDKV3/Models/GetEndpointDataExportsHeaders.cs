...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetEndpointDataExportsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetEndpointDataExportsHeaders
        /// class.
        /// </summary>
        public GetEndpointDataExportsHeaders()
        {
            CustomInit();
        }
        ...
        public GetEndpointDataExportsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
