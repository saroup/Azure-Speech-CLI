...
namespace Speech.Models
{
    ...
    /// PaginatedModels
    /// </summary>
    public partial class PaginatedModels
    {
        /// <summary>
        /// Initializes a new instance of the PaginatedModels class.
        /// </summary>
        ...
        public PaginatedModels(IList<Model> values = default(IList<Model>), string nextLink = default(string))
        {
            Values = values;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<Model> Values { get; private set; }
