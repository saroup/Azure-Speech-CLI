...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateSsmlFolder operation.
    /// </summary>
    public partial class CreateSsmlFolderHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateSsmlFolderHeaders class.
        /// </summary>
        public CreateSsmlFolderHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateSsmlFolderHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
