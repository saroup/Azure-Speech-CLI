...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceSynthesesPaginated operation.
    /// </summary>
    public partial class GetVoiceSynthesesPaginatedHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceSynthesesPaginatedHeaders
        /// class.
        /// </summary>
        public GetVoiceSynthesesPaginatedHeaders()
        {
            CustomInit();
        }
        ...
        public GetVoiceSynthesesPaginatedHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
