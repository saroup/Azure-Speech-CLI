...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteBaseModelLogs operation.
    /// </summary>
    public partial class DeleteBaseModelLogsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteBaseModelLogsHeaders class.
        /// </summary>
        public DeleteBaseModelLogsHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteBaseModelLogsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
