...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateKeywordModel operation.
    /// </summary>
    public partial class CreateKeywordModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateKeywordModelHeaders class.
        /// </summary>
        public CreateKeywordModelHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateKeywordModelHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
