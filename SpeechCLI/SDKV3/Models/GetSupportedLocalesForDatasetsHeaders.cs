...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetSupportedLocalesForDatasetsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedLocalesForDatasetsHeaders class.
        /// </summary>
        public GetSupportedLocalesForDatasetsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedLocalesForDatasetsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
