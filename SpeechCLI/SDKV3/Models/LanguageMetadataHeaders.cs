...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for LanguageMetadata operation.
    /// </summary>
    public partial class LanguageMetadataHeaders
    {
        /// <summary>
        /// Initializes a new instance of the LanguageMetadataHeaders class.
        /// </summary>
        public LanguageMetadataHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public LanguageMetadataHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
