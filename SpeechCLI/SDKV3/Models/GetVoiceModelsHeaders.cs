...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetVoiceModelsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceModelsHeaders class.
        /// </summary>
        public GetVoiceModelsHeaders()
        {
            CustomInit();
        }
        ...
        public GetVoiceModelsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
