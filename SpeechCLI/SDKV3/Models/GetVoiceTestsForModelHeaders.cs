...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceTestsForModel operation.
    /// </summary>
    public partial class GetVoiceTestsForModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceTestsForModelHeaders
        /// class.
        /// </summary>
        public GetVoiceTestsForModelHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceTestsForModelHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
