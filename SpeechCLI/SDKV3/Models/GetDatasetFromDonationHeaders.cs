...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDatasetFromDonation operation.
    /// </summary>
    public partial class GetDatasetFromDonationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDatasetFromDonationHeaders
        /// class.
        /// </summary>
        public GetDatasetFromDonationHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetDatasetFromDonationHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
