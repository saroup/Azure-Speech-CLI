...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CopyModel operation.
    /// </summary>
    public partial class CopyModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CopyModelHeaders class.
        /// </summary>
        public CopyModelHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CopyModelHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
