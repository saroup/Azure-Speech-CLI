...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateDataset operation.
    /// </summary>
    public partial class CreateDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateDatasetHeaders class.
        /// </summary>
        public CreateDatasetHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateDatasetHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
