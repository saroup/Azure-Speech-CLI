...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateDataCollectionDonation operation.
    /// </summary>
    public partial class CreateDataCollectionDonationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateDataCollectionDonationHeaders class.
        /// </summary>
        public CreateDataCollectionDonationHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateDataCollectionDonationHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
