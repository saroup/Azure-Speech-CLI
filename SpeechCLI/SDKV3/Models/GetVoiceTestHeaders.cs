...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetVoiceTestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceTestHeaders class.
        /// </summary>
        public GetVoiceTestHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceTestHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
