...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DownloadTuneSsmlAsZip operation.
    /// </summary>
    public partial class DownloadTuneSsmlAsZipHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DownloadTuneSsmlAsZipHeaders
        /// class.
        /// </summary>
        public DownloadTuneSsmlAsZipHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public DownloadTuneSsmlAsZipHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
