...
namespace Speech.Models
{
    ...
    /// <summary>
    /// PaginatedDataCollectionDonations
    /// </summary>
    public partial class PaginatedDataCollectionDonations
    {
        /// <summary>
        /// Initializes a new instance of the PaginatedDataCollectionDonations
        /// class.
        /// </summary>
        public PaginatedDataCollectionDonations()
        {
            CustomInit();
        }
        ...
        public PaginatedDataCollectionDonations(IList<DataCollectionDonation> values = default(IList<DataCollectionDonation>), string nextLink = default(string))
        {
            Values = values;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<DataCollectionDonation> Values { get; private set; }
