...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetVoiceDatasetsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceDatasetsHeaders class.
        /// </summary>
        public GetVoiceDatasetsHeaders()
        {
            CustomInit();
        }
        ...
        public GetVoiceDatasetsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
