...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordDatasetFiles operation.
    /// </summary>
    public partial class GetKeywordDatasetFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeywordDatasetFilesHeaders
        /// class.
        /// </summary>
        public GetKeywordDatasetFilesHeaders()
        {
            CustomInit();
        }
        ...
        public GetKeywordDatasetFilesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
