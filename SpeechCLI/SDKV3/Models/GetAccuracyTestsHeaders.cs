...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetAccuracyTestsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetAccuracyTestsHeaders class.
        /// </summary>
        public GetAccuracyTestsHeaders()
        {
            CustomInit();
        }
        ...
        public GetAccuracyTestsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
