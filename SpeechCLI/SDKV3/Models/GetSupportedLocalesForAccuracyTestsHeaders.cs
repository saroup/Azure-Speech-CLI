...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetSupportedLocalesForAccuracyTests operation.
    /// </summary>
    public partial class GetSupportedLocalesForAccuracyTestsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedLocalesForAccuracyTestsHeaders class.
        /// </summary>
        public GetSupportedLocalesForAccuracyTestsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedLocalesForAccuracyTestsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
