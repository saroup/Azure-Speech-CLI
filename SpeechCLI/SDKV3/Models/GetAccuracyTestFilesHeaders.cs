...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetAccuracyTestFiles operation.
    /// </summary>
    public partial class GetAccuracyTestFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetAccuracyTestFilesHeaders
        /// class.
        /// </summary>
        public GetAccuracyTestFilesHeaders()
        {
            CustomInit();
        }
        ...
        public GetAccuracyTestFilesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
