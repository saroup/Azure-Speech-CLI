...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class CreateTranscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateTranscriptionHeaders class.
        /// </summary>
        public CreateTranscriptionHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateTranscriptionHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
