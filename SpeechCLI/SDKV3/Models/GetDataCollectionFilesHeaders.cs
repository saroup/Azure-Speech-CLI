...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDataCollectionFiles operation.
    /// </summary>
    public partial class GetDataCollectionFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDataCollectionFilesHeaders
        /// class.
        /// </summary>
        public GetDataCollectionFilesHeaders()
        {
            CustomInit();
        }
        ...
        public GetDataCollectionFilesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
