...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for QueryAudioFiles operation.
    /// </summary>
    public partial class QueryAudioFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the QueryAudioFilesHeaders class.
        /// </summary>
        public QueryAudioFilesHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public QueryAudioFilesHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
