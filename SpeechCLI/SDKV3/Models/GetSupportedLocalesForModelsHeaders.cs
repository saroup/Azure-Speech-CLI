...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetSupportedLocalesForModelsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetSupportedLocalesForModelsHeaders class.
        /// </summary>
        public GetSupportedLocalesForModelsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSupportedLocalesForModelsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
