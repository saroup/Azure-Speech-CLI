...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetTranscriptionFile operation.
    /// </summary>
    public partial class GetTranscriptionFileHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTranscriptionFileHeaders
        /// class.
        /// </summary>
        public GetTranscriptionFileHeaders()
        {
            CustomInit();
        }
        ...
        public GetTranscriptionFileHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
