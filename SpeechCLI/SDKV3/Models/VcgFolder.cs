...
namespace Speech.Models
{
    ...
    /// VcgFolder
    /// </summary>
    public partial class VcgFolder
    {
        /// <summary>
        /// Initializes a new instance of the VcgFolder class.
        /// </summary>
        public VcgFolder()
        {
            CustomInit();
        ...
        /// created</param>
        public VcgFolder(System.Guid id, string name, IList<IVcgTask> children = default(IList<IVcgTask>), System.Guid? parentId = default(System.Guid?), string editStatus = default(string), IList<VcgFolder> foldersFromRootToParent = default(IList<VcgFolder>), IDictionary<string, string> properties = default(IDictionary<string, string>), string taskType = default(string), string state = default(string), IList<string> tags = default(IList<string>), string parentIdPath = default(string), string description = default(string), System.DateTime? lastActionDateTime = default(System.DateTime?), string status = default(string), System.DateTime? createdDateTime = default(System.DateTime?))
        {
            Children = children;
            ParentId = parentId;
        ...
        public IList<IVcgTask> Children { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            {
                foreach (var element1 in FoldersFromRootToParent)
                {
                    if (element1 != null)
                    {
                        element1.Validate();
