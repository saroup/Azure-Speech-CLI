...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordModel operation.
    /// </summary>
    public partial class GetKeywordModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeywordModelHeaders class.
        /// </summary>
        public GetKeywordModelHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetKeywordModelHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
