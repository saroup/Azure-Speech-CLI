...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for MultiTune operation.
    /// </summary>
    public partial class MultiTuneHeaders
    {
        /// <summary>
        /// Initializes a new instance of the MultiTuneHeaders class.
        /// </summary>
        public MultiTuneHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public MultiTuneHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
