...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetBaseModel operation.
    /// </summary>
    public partial class GetBaseModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetBaseModelHeaders class.
        /// </summary>
        public GetBaseModelHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetBaseModelHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
