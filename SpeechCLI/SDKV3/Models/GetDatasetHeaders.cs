...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDatasetHeaders class.
        /// </summary>
        public GetDatasetHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetDatasetHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
