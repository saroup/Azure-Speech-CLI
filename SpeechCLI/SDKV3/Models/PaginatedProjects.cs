...
namespace Speech.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PaginatedProjects class.
        /// </summary>
        ...
        public PaginatedProjects(IList<Project> values = default(IList<Project>), string nextLink = default(string))
        {
            Values = values;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<Project> Values { get; private set; }
