...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class DeleteTranscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteTranscriptionHeaders class.
        /// </summary>
        public DeleteTranscriptionHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteTranscriptionHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
