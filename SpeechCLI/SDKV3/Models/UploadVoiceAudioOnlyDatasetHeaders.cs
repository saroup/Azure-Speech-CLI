...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UploadVoiceAudioOnlyDataset operation.
    /// </summary>
    public partial class UploadVoiceAudioOnlyDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// UploadVoiceAudioOnlyDatasetHeaders class.
        /// </summary>
        public UploadVoiceAudioOnlyDatasetHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public UploadVoiceAudioOnlyDatasetHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
