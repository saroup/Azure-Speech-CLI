...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UploadSsmlFiles operation.
    /// </summary>
    public partial class UploadSsmlFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UploadSsmlFilesHeaders class.
        /// </summary>
        public UploadSsmlFilesHeaders()
        {
            CustomInit();
        }
        ...
        /// resource.</param>
        public UploadSsmlFilesHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), string location = default(string))
        {
