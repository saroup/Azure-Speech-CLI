...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetEndpointsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetEndpointsHeaders class.
        /// </summary>
        public GetEndpointsHeaders()
        {
            CustomInit();
        }
        ...
        public GetEndpointsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
