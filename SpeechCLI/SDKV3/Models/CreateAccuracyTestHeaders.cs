...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class CreateAccuracyTestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateAccuracyTestHeaders class.
        /// </summary>
        public CreateAccuracyTestHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateAccuracyTestHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
