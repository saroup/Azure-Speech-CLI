...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetEndpointDataExportsForProject operation.
    /// </summary>
    public partial class GetEndpointDataExportsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetEndpointDataExportsForProjectHeaders class.
        /// </summary>
        public GetEndpointDataExportsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        public GetEndpointDataExportsForProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
