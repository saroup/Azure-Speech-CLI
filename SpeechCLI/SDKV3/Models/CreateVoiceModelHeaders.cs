...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class CreateVoiceModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateVoiceModelHeaders class.
        /// </summary>
        public CreateVoiceModelHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateVoiceModelHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
