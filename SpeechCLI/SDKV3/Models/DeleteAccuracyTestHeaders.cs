...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class DeleteAccuracyTestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteAccuracyTestHeaders class.
        /// </summary>
        public DeleteAccuracyTestHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteAccuracyTestHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
