...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetEndpointsForProject operation.
    /// </summary>
    public partial class GetEndpointsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetEndpointsForProjectHeaders
        /// class.
        /// </summary>
        public GetEndpointsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        public GetEndpointsForProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
