...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class UpdateDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateDatasetHeaders class.
        /// </summary>
        public UpdateDatasetHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateDatasetHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
