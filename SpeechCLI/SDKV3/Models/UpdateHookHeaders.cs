...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateHook operation.
    /// </summary>
    public partial class UpdateHookHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateHookHeaders class.
        /// </summary>
        public UpdateHookHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateHookHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
