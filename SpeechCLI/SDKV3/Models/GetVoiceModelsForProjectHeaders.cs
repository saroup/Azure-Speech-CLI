...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceModelsForProject operation.
    /// </summary>
    public partial class GetVoiceModelsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceModelsForProjectHeaders
        /// class.
        /// </summary>
        public GetVoiceModelsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetVoiceModelsForProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
