...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteVoiceAudioFiles operation.
    /// </summary>
    public partial class DeleteVoiceAudioFilesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteVoiceAudioFilesHeaders
        /// class.
        /// </summary>
        public DeleteVoiceAudioFilesHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteVoiceAudioFilesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
