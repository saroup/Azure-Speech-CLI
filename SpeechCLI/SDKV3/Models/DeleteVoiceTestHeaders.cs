...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class DeleteVoiceTestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteVoiceTestHeaders class.
        /// </summary>
        public DeleteVoiceTestHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteVoiceTestHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
