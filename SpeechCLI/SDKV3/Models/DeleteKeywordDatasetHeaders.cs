...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for DeleteKeywordDataset operation.
    /// </summary>
    public partial class DeleteKeywordDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteKeywordDatasetHeaders
        /// class.
        /// </summary>
        public DeleteKeywordDatasetHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteKeywordDatasetHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
