...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetDatasetsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDatasetsHeaders class.
        /// </summary>
        public GetDatasetsHeaders()
        {
            CustomInit();
        }
        ...
        public GetDatasetsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
