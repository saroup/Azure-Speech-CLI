...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetVoiceDeploymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceDeploymentsHeaders class.
        /// </summary>
        public GetVoiceDeploymentsHeaders()
        {
            CustomInit();
        }
        ...
        public GetVoiceDeploymentsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
