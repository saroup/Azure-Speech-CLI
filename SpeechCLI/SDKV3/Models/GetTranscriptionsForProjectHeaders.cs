...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetTranscriptionsForProject operation.
    /// </summary>
    public partial class GetTranscriptionsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetTranscriptionsForProjectHeaders class.
        /// </summary>
        public GetTranscriptionsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        public GetTranscriptionsForProjectHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
