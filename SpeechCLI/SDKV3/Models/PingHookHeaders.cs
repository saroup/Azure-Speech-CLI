...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for PingHook operation.
    /// </summary>
    public partial class PingHookHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PingHookHeaders class.
        /// </summary>
        public PingHookHeaders()
        {
            CustomInit();
        }
        ...
        public PingHookHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
