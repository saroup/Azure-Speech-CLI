...
namespace Speech.Models
{
    ...
    /// <summary>
    /// PaginatedVoiceSyntheses
    /// </summary>
    public partial class PaginatedVoiceSyntheses
    {
        /// <summary>
        /// Initializes a new instance of the PaginatedVoiceSyntheses class.
        /// </summary>
        public PaginatedVoiceSyntheses()
        {
            CustomInit();
        }
        ...
        public PaginatedVoiceSyntheses(IList<VoiceSynthesis> values = default(IList<VoiceSynthesis>), string nextLink = default(string))
        {
            Values = values;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<VoiceSynthesis> Values { get; private set; }
