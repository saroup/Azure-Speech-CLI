...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordModelsForProject operation.
    /// </summary>
    public partial class GetKeywordModelsForProjectHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeywordModelsForProjectHeaders
        /// class.
        /// </summary>
        public GetKeywordModelsForProjectHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetKeywordModelsForProjectHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
