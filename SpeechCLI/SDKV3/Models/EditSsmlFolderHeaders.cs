...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for EditSsmlFolder operation.
    /// </summary>
    public partial class EditSsmlFolderHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditSsmlFolderHeaders class.
        /// </summary>
        public EditSsmlFolderHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public EditSsmlFolderHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
