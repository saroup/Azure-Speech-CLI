...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class DeleteDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteDatasetHeaders class.
        /// </summary>
        public DeleteDatasetHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteDatasetHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
