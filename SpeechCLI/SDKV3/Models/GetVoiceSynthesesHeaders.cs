...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetVoiceSyntheses operation.
    /// </summary>
    public partial class GetVoiceSynthesesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVoiceSynthesesHeaders class.
        /// </summary>
        public GetVoiceSynthesesHeaders()
        {
            CustomInit();
        }
        ...
        public GetVoiceSynthesesHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
