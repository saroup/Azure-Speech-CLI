...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateKeywordModel operation.
    /// </summary>
    public partial class UpdateKeywordModelHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateKeywordModelHeaders class.
        /// </summary>
        public UpdateKeywordModelHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateKeywordModelHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
