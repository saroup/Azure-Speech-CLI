...
namespace Speech.Models
{
    ...
    /// </summary>
    public partial class GetModelsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetModelsHeaders class.
        /// </summary>
        public GetModelsHeaders()
        {
            CustomInit();
        }
        ...
        public GetModelsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
