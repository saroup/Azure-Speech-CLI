...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for QueryVoices operation.
    /// </summary>
    public partial class QueryVoicesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the QueryVoicesHeaders class.
        /// </summary>
        public QueryVoicesHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public QueryVoicesHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
