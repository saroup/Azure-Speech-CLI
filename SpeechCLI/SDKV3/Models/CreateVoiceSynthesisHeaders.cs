...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateVoiceSynthesis operation.
    /// </summary>
    public partial class CreateVoiceSynthesisHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateVoiceSynthesisHeaders
        /// class.
        /// </summary>
        public CreateVoiceSynthesisHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public CreateVoiceSynthesisHeaders(string location = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
