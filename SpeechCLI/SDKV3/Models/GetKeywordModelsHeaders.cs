...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for GetKeywordModels operation.
    /// </summary>
    public partial class GetKeywordModelsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetKeywordModelsHeaders class.
        /// </summary>
        public GetKeywordModelsHeaders()
        {
            CustomInit();
        }
        ...
        public GetKeywordModelsHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
