...
namespace Speech.Models
{
    ...
    /// <summary>
    /// Defines headers for UpdateVoiceTest operation.
    /// </summary>
    public partial class UpdateVoiceTestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateVoiceTestHeaders class.
        /// </summary>
        public UpdateVoiceTestHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateVoiceTestHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
